          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-text-secondary max-w-xl">
                Explore a complete investigation with real-looking results. Every data point below
                was generated in under 45 seconds from a single email or domain input.
              </p>
            </div>
