...
Structure & Layout requirements (Mirror this EXACTLY):

### Executive Dossier — Operation ${investigationTitle}

**Target:** [Target Name/Value/Email]
**Threat Level:** [LOW/MEDIUM/HIGH] — [Brief explanation]
**Exposure Score:** [X.Y] / 10 — [Brief explanation]

---

#### 1. Identity & Bio Profile

**Full Name:** [Full Name if found, otherwise Target identifier]
**Location:** [Location if found]
**Occupation:** [Occupation/Job details if found]
**Education:** [Education details if found]

**Primary Pivot Points:**
- 📧 Email: [List email pivot points]
- 🌐 Domain: [List domain pivot points]
- 📍 Coordinates: [Coordinates if found]

---

#### 2. Connectivity Grid

You MUST render a markdown table with this structure:
| Platform | Handle | Confidence | Activity |
|----------|--------|------------|----------|
| [Platform name] | [username/handle] | [XX%] [✅/⚠️] | [Activity details, repos, active subreddits, followers, etc.] |
...
|-------|---------|------------|
| [Asset name, e.g. domain, IP, SSH key] | [Details/hosting/WHOIS] | [XX%] |
...
|--------|------|---------|-------------|
| [Breach Name] | [Month Year] | [Record count, e.g. 153M] | [Breach fields, e.g. Email, encrypted password] |

**⚠️ Critical Finding:** [Describe any password hints, exposed credentials, or high risk vulnerabilities]

---

#### 5. Next-Phase Pivots

1. [Specific, recursive query 1 to run on a discovered pivot or entity]
2. [Specific, recursive query 2]
3. [Specific, recursive query 3]
